...
SECRET_KEY = os.environ.get(
    "SECRET_KEY",
    "django-insecure-fallback-safarisacco-secret-key-2026"
)
...
ALLOWED_HOSTS = [
    host.strip() for host in os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,0.0.0.0").split(",") if host.strip()
]
